...
import com.detroitlabs.nerdnite.api.RestAPI_;
    ...
    extends LocationListActivity
{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(layout.activity_location_list);
    }

    private void init_(Bundle savedInstanceState) {
        api = RestAPI_.getInstance_(this);
    }

    private void afterSetContentView_() {
        locationList = ((ListView) findViewById(id.locationList));
        ((RestAPI_) api).afterSetContentView_();
        getLocationList();
    }
